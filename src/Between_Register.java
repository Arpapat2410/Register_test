...
class Between_Register {
	...
	void test() throws InterruptedException {		
		...
		String result1 = driver.findElement(By.xpath("//*[@id=\"item-vfb-1\"]/div")).getText();
        assertEquals("Register For Demo",result1);
		...
		String result2 = driver.findElement(By.xpath("//*[@id=\"item-vfb-14\"]/label[1]")).getText();
		assertEquals("Email *",result2);
		...
		String result3 = driver.findElement(By.xpath("//*[@id=\"item-vfb-2\"]/div/h3")).getText();
		assertEquals("Verification",result3);
